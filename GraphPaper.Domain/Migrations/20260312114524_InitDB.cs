        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExtractedEntities_DocumentChunks_ChunkId",
                        column: x => x.ChunkId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExtractedRelationships", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExtractedRelationships_ExtractedEntities_SourceEntityId",
                        column: x => x.SourceEntityId,
                        principalTable: "ExtractedEntities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExtractedRelationships_ExtractedEntities_TargetEntityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExtractedEntities_ChunkId",
                table: "ExtractedEntities",
                column: "ChunkId");

            migrationBuilder.CreateIndex(
                name: "IX_ExtractedRelationships_SourceEntityId",
                table: "ExtractedRelationships",
                column: "SourceEntityId");

            migrationBuilder.CreateIndex(
                name: "IX_ExtractedRelationships_TargetEntityId",
                table: "ExtractedRelationships",
                column: "TargetEntityId");

            migrationBuilder.CreateIndex(
                name: "IX_MessageCitations_ChunkId",
